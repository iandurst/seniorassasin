...
/**
 * db.js — Airtable-backed key/value JSON store (replaces Netlify Blob)
 *
 * Env:
...
async function getUnsubscribed(){ return await readJson('unsubscribed.json', []); }
async function saveUnsubscribed(list){ return await writeJson('unsubscribed.json', list); }
...
module.exports = { 
  ...
  getVotes, saveVotes,
  getUnsubscribed, saveUnsubscribed,
