...
async function getSettings(){
  const defaults = { entryFee: 0, prizePoolOverride: null, week: 0, lastStart: null, gameOver: false };
...
async function getCurrentVote(){ return await readJson('vote-current.json', null); }
async function saveCurrentVote(v){ return await writeJson('vote-current.json', v); }

module.exports = { getParticipants, saveParticipants, getSettings, saveSettings, saveAssignments, getAssignments, getCurrentVote, saveCurrentVote };
