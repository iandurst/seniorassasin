...
async function getStatus(week){ return await readJson(`status-week-${week}.json`, {}); }
async function saveStatus(week, map){ return await writeJson(`status-week-${week}.json`, map); }
...
module.exports = {
  ...
  deleteJson, listByPrefix, batchDelete
};
