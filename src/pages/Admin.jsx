        ...
        <div className="space-y-6">
          <div className="card p-4">
            <div className="flex gap-2 flex-wrap items-center">
              <button className="btn-ghost" onClick={async()=>{ await api.startWeek(); await refresh(); try { const res = await api.targets(); setTargets(res.assignments || []) } catch {} }}>Start Week</button>
